...
-- ----------------------------
INSERT INTO `database_info` VALUES (1240625039548657665, 'master', 'com.mysql.cj.jdbc.Driver', 'root', '123456', 'jdbc:mysql://192.168.11.128:3306/guns_advanced?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=CONVERT_TO_NULL&useSSL=false&serverTimezone=CTT', '主数据源，项目启动数据源！', '2020-03-19 21:03:53');
